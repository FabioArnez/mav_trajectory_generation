#ifndef MAV_TRAJECTORY_GENERATION_EXAMPLE_PLANNER_4DOF_H
#define MAV_TRAJECTORY_GENERATION_EXAMPLE_PLANNER_4DOF_H

#include <iostream>
#include <Eigen/Dense>
#include "mav_trajectory_generation/polynomial_optimization_nonlinear.h"

class ExamplePlanner4D {
    public:
        ExamplePlanner4D();
...
#endif // MAV_TRAJECTORY_GENERATION_EXAMPLE_PLANNER_4DOF_H