...
TrajectoryPlanner4DOF::TrajectoryPlanner4DOF()
    : max_v_(2.0),
      max_a_(2.0),
...
void TrajectoryPlanner4DOF::setMaxSpeed(const double max_v) {
  max_v_ = max_v;
}

// Method to get maximum speed.
double TrajectoryPlanner4DOF::getMaxSpeed() const {
  return max_v_;
}

// Method to set maximum acceleration.
void TrajectoryPlanner4DOF::setMaxAcceleration(const double max_a) {
  max_a_ = max_a;
}

// Method to get maximum acceleration.
double TrajectoryPlanner4DOF::getMaxAcceleration() const {
  return max_a_;
}

// Method to set current pose.
void TrajectoryPlanner4DOF::setCurrentPose(const Eigen::Affine3d& pose) {
  current_pose_ = pose;
}

// Method to set current velocity.
void TrajectoryPlanner4DOF::setCurrentVelocity(const Eigen::Vector4d& velocity) {
  current_velocity_ = velocity;
}

// Plans a trajectory from the current position to the a goal position and velocity
bool TrajectoryPlanner4DOF::planTrajectory(const Eigen::VectorXd& goal_pos,
...
bool TrajectoryPlanner4DOF::saveTrajectoryToCSV(const mav_trajectory_generation::Trajectory& trajectory,
